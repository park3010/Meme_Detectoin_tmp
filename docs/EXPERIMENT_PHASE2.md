...
```bash
python scripts/run_ours_full.py --dataset harm_c --seed 42 --epochs 5
python scripts/evaluate_structured_outputs.py --dataset harm_c --model ours_full --seed 42

python scripts/run_ablation.py --dataset harm_c --ablation w_o_roi --seed 42
python scripts/run_ablation.py --dataset harm_c --ablation w_o_verifier --seed 42
python scripts/run_ablation.py --dataset harm_c --fusion-mode task_aware_gate_verified --seed 42
