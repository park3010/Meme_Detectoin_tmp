...
## Run path
`result_cleanup_cpu_smoke_no_tqdm_tiny/predictions/harm_c/ours_full/42`

## Artifact discovery
- training_log: `result_cleanup_cpu_smoke_no_tqdm_tiny/predictions/harm_c/ours_full/42/training_log.json`
- predictions: `result_cleanup_cpu_smoke_no_tqdm_tiny/predictions/harm_c/ours_full/42/final_predictions.jsonl`
- metrics: `result_cleanup_cpu_smoke_no_tqdm_tiny/predictions/harm_c/ours_full/42/metrics.json`
- manifest: `result_cleanup_cpu_smoke_no_tqdm_tiny/predictions/harm_c/ours_full/42/run_manifest.json`
- tactic_decoding: `result_cleanup_cpu_smoke_no_tqdm_tiny/predictions/harm_c/ours_full/42/tactic_rhetorical_decoding.json`
- best_model: `result_cleanup_cpu_smoke_no_tqdm_tiny/predictions/harm_c/ours_full/42/best_model.pt`
- validation_predictions: `result_cleanup_cpu_smoke_no_tqdm_tiny/predictions/harm_c/ours_full/42/validation_predictions.jsonl`
...
- Split sizes: `{'train': 5, 'valid': 0, 'test': 0}`
...
- Non-empty metrics were required, but no usable metric values were found.
