...
def build_parser() -> argparse.ArgumentParser:
    ...
    add_data_commands(subparsers, DEFAULT_CONFIG)
    add_report_commands(subparsers, DEFAULT_CONFIG)
    add_analysis_commands(subparsers, DEFAULT_CONFIG)
    return parser
...
def _cmd_train(args: argparse.Namespace) -> None:
    ...
    progress_config = _progress_config(args)
...
def _cmd_stage(args: argparse.Namespace) -> None:
    ...
    runner = PipelineRunner(args.config, overrides=overrides, progress=_progress_config(args))
...
def _cmd_suite(args: argparse.Namespace) -> None:
    args.progress_config = _progress_config(args)
