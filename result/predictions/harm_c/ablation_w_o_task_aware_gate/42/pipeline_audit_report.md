...
## Run path
`result/predictions/harm_c/ablation_w_o_task_aware_gate/42`

## Artifact discovery
- training_log: missing
- predictions: `result/predictions/harm_c/ablation_w_o_task_aware_gate/42/final_predictions.jsonl`
- metrics: `result/predictions/harm_c/ablation_w_o_task_aware_gate/42/metrics.json`
- manifest: `result/predictions/harm_c/ablation_w_o_task_aware_gate/42/run_manifest.json`

## Run manifest
- Schema: `experiment_run_manifest_v1`
- Run kind: `ablation`
- Run name: `ablation_w_o_task_aware_gate`
